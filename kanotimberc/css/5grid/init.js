...
/** ****************** */
	 ...
	 * "Cowboy" Ben Alman | Dual licensed under the MIT and GPL licenses. |
...
/** ****************** */
	...
	(function() {
		...
		// mode, so we
		// do a little trick here to detect this condition and make things
		// right.
							...
							// Animate
								_wrapper.add(_titlebar)
									.animate({ left: _nav_width }, speed, easing, function() {
										...
										// Correct body position (in case it was
										// still scrolling when the nav opened)
